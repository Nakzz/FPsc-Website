...
<body id="page-top">
  ...
  <div class="outer-wrap">
    <div class="container">
      ...
      <?php include 'assets/vertical_navbar.php'; ?>
      ...
      <div class="col-md-9 m-right">
        ...
        <div class="row" data-animated="0">
          <div class="col-md-12">
            <div id="page-header">
              <h3><span>Blog</span></h3>  <?php // TODO: Change to name of the page using PHP ?>
              <ul class="bread_crumbs">
                <li><a href="index.php">home</a></li>
                <li>blog</li>   <?php // TODO: Change to name of the page using PHP ?>
              </ul>
            </div>
          </div>
        </div>
              ...
              <div class="row">
                <div class="col-md-12">
                  <article class="item">
                    ...
                    <h4>Improving and Removing Envato Market Image Watermarking</h4>
