...
gulp.task('js', function() {
  gulp.src(['./src/scripts/priority/**/*.js ', './src/scripts/vendors/**/*.js ', './src/scripts/z_custom/*.js', '!./src/scripts/*.min.js'])
  .pipe(sourcemaps.init())
    .pipe(uglify())
...
browserSync.init({
  ...
  gulp.watch('./src/styles/**/!(_all).scss', ['sass']).on('change', browserSync.reload);
