              ...
              <div class="row">
                <div class="col-md-12">
                  <article class="item">
                    ...
                    <h4>FPsc: Plant-Based Resources that Enable an Integrated Approach to Education in Genetics, Evolution, and Genomic Sciences</h4>
                    <p>Our lab group in the laboratory of Prof. Rick Amasino, UW-Madison Department of Biochemistry, has been working for several years to develop plant and molecular resources that we believe will be useful to enhance K-12 and undergraduate science education. Briefly, we have bred a self-compatible and extensively inbred analog of the Wisconsin Fast Plants (WFP) variety of rapid-cycling <em>Brassica rapa</em> that we have dubbed FPsc (Fast Plants, self-compatible). The fundamental difference between WFP and FPsc varieties is that FPsc is self-compatible (sc; capable of propagation through self-pollination) and highly inbred, a property that facilitated the generation of mutant derivatives and facilitates subsequent analysis by students. We have also developed a complementary collection of molecular tools that helps teachers and students to bridge the gap between Mendelian and molecular genetics.</p>
                     <img src="assets/img/students.jpg" hspace="5" vspace="5" align="right"/>
