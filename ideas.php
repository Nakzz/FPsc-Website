...
<!-- Fixed Left Navigaton END-->
				...
				<div class="col-md-12">
					<div id="intro">
						<div id="intro-slider" class="owl-carousel owl-theme">
							<div class="item"><img src="img/slider/intro/1.jpg" class="img-responsive" alt=""></div>
							<div class="item"><img src="img/slider/intro/2.jpg" class="img-responsive" alt=""></div>
							<div class="item"><img src="img/slider/intro/3.jpg" class="img-responsive" alt=""></div>
						</div>
					</div>
				</div>
			</div>
      ...
      <!-- Welcome Content -->
			...
			<div class="row" data-animated="0">
				<div class="col-md-12">
					<div id="services" class="trans-bg">
						<ul>
							<li class="s1">
			...
			<div class="row" data-animated="0">
				<div class="col-md-12">
					<div id="m-portfolio" class="trans-bg">
						<h3>Portfolio</h3>
						<div class="row">
			...
			<div class="row">
				<div class="col-md-12">
					<div id="blog" class="trans-bg" data-animated="0">
						<h3>Blog Posts</h3>
			...
			<div class="row" data-animated="0">
				<div class="col-md-12">
					<div class="col-md-12 trans-bg" id="m-pricing">
						<h3>Pricing tables</h3>
						<div class="row">
							<div class="col-md-4">
								<div class="pricing-table pt1">
			...
			<div class="row" data-animated="0">
				<div class="col-md-12">
					<div class="col-md-12 trans-bg" id="m-testimonials">
						<h3>Testimonials</h3>
						<div class="row">
							<div class="col-md-12">
			...
			<div class="row" data-animated="0">
				<div class="col-md-12">
					<div class="col-md-12 trans-bg" id="icons-wrap">
						<h3>Font Awesome</h3>
						<ul>
			...
			<div class="row" data-animated="0">
				<div class="col-md-12">
					<div class="col-md-12 trans-bg" id="vertical-tabs">
						<h3>Vertikal Tabs</h3>
						<!--vertical Tabs-->
						<div id="verticalTab">
			...
			<div class="row" data-animated="0">
				<div class="col-md-12">
					<div class="col-md-12 trans-bg" id="timeline-wrap">
						<h3>Timeline</h3>
						<ol id="timeline">
							<li class="t-left">
								<time>Lorem ipsum<span>2000 - 2005</span></time>
								<p>Proin gravida nibh vel velit auctor aliquet. Aenean sollicitudin, lorem quis bibendum auctor, nisi elit</p>
							</li>
							<li class="t-right">
								<time>Dolor sit<span>2000 - 2005</span></time>
								<p>Proin gravida nibh vel velit auctor aliquet. Aenean sollicitudin, lorem quis bibendum auctor, nisi elit</p>
							</li>
							<li class="t-left">
								<time>Aenan Auctor<span>2000 - 2005</span></time>
								<p>Proin gravida nibh vel velit auctor aliquet. Aenean sollicitudin, lorem quis bibendum auctor, nisi elit</p>
							</li>
							<li class="t-right">
								<time>Gravida prin<span>2000 - 2005</span></time>
								<p>Proin gravida nibh vel velit auctor aliquet. Aenean sollicitudin, lorem quis bibendum auctor, nisi elit</p>
							</li>
							<li class="t-left">
								<time>Lorem Quis<span>2000 - 2005</span></time>
								<p>Proin gravida nibh vel velit auctor aliquet. Aenean sollicitudin, lorem quis bibendum auctor, nisi elit</p>
							</li>
							<li class="t-right">
								<time>Bibendum<span>2000 - 2005</span></time>
								<p>Proin gravida nibh vel velit auctor aliquet. Aenean sollicitudin, lorem quis bibendum auctor, nisi elit</p>
							</li>
							<li class="t-left">
								<time>Nisi solic<span>2000 - 2005</span></time>
								<p>Proin gravida nibh vel velit auctor aliquet. Aenean sollicitudin, lorem quis bibendum auctor, nisi elit</p>
							</li>
							<li class="t-right">
								<time>Proin Gravida<span>2000 - 2005</span></time>
								<p>Proin gravida nibh vel velit auctor aliquet. Aenean sollicitudin, lorem quis bibendum auctor, nisi elit</p>
							</li>
						</ol>
					</div>
			...
			<div class="row" data-animated="0">
				<div class="col-md-12">
					<div class="col-md-12 trans-bg" id="m-products">
						<h3>Our Products</h3>
						<div class="row">
							<div class="col-md-4">
			...
			<div class="row" data-animated="0">
				<div class="col-md-12">
					<div class="col-md-12 trans-bg" id="m-promo">
						<h3>Promo banner</h3>
